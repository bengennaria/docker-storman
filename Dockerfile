...
curl -o /tmp/msm_linux.tgz http://download.adaptec.com/raid/storage_manager/msm_linux_x64_v2_06_23164.tgz && \
tar -xf /tmp/msm_linux.tgz -C /tmp && \
DEBIAN_FRONTEND=noninteractive dpkg -i /tmp/manager/StorMan-2.06-23164_amd64.deb && \
